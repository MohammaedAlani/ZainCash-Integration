...
if (isset($_GET['token'])){
	...
	if ($result['status']=='success'){
		...
		array(5) {
			["status"]=>
			string(7) "success"                         >>> So you can know if the payment is done or not
			["orderid"]=>
			string(9) "Bill12345"                       >>> Your order id that you've sent
			["id"]=>
			string(24) "58650f0f90c6362288da08cf"       >>> Transaction ID
			["iat"]=>
			int(1483018052)
			["exp"]=>
			int(1483032452)
